...
export default function AnimatedText({
  ...
  return (
    <motion.h1
      ...
      className="flex items-center my-16 font-['Six_Caps'] font-normal text-[calc(1rem+16.15vw)] text-black dark:text-white uppercase leading-[calc(1rem+14.15vw)] cursor-pointer"
    >
